...
export default function PlayerPage() {
    ...
    return (
        <main className="flex justify-center min-h-screen flex-col items-center bg-gradient-to-b from-slate-800 to-gray-900">
            ...
            <XShareButton className="flex items-center justify-center bg-[#000000] text-blue font-medium px-4 py-2 rounded-lg" text="I just got my Nightclub Wrapped for 2024!" url="http://localhost:3002" />
            <br />
